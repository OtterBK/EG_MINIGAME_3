...
public class WizardPowder extends SpecialWeapon{
	...
	public WizardPowder(Minigame minigame) {
		super(minigame, Material.BLAZE_POWDER, 1, (short)0, "마도사의 파우치", 8, 9); //아이템코드, 갯수, 데이터코드, 이름, 최소뎀, 최대뎀
		
		List<String> loreList = new ArrayList<String>();
				
		//설명 설정
		loreList.add("§e히어로즈워 마도사 사용하는 파우치다.");
		loreList.add("§e조금 약해졌지만 불의 힘이 담겨있다.");
		loreList.add("§e우클릭시 화염덩이를 날린다.");
		loreList.add("§7화염덩이는 착탄시 불구덩이를 만들며");
		loreList.add("§7불구덩이 내의 적에게 초당 8의 피해와");
		loreList.add("§76초의 화상피해를 입힌다.");
		loreList.add("");
